...
第一、第二、第三阶段已经分别封存在中文分支中；当前 `第四阶段分支` 已完成本机原声视频念想的开发与自动化验收，等待用户对真实原声视频进行最终确认：
...
- Next.js 正式响应式 Web，包含家庭首页、开始记录、回忆档案和家庭管理四个入口；
...
验收状态见 [第一阶段验收记录](docs/第一阶段验收记录.md)、[第二阶段验收记录](docs/第二阶段验收记录.md)、[第三阶段验收记录](docs/第三阶段验收记录.md)、[第四阶段验收记录](docs/第四阶段验收记录.md) 和 [第四阶段人工验收清单](docs/第四阶段人工验收清单.md)。
