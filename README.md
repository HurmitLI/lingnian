...
第一、第二、第三、第四阶段已经分别保存在中文分支中；`第五阶段分支` 已完成 V0.9 全站前端重构和电脑/手机人工验收。当前在 `第五阶段私密上线分支` 进行 5B 上线适配，尚未创建云资源或上传真实家庭资料：
...
5B 的架构取舍与开发顺序见 [第五阶段私密上线技术适配声明](第五阶段私密上线技术适配声明.md) 和 [第五阶段私密上线开发手册](第五阶段私密上线开发手册.md)。
