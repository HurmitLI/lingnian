...
第一、第二阶段已经分别封存在中文分支中；当前 `第三阶段分支` 已完成正式响应式 Web 的开发与自动化验收，等待真实手机麦克风最终验收：
...
验收状态见 [第一阶段验收记录](docs/第一阶段验收记录.md)、[第二阶段验收记录](docs/第二阶段验收记录.md)、[第三阶段验收记录](docs/第三阶段验收记录.md) 和 [第三阶段真机验收清单](docs/第三阶段真机验收清单.md)。
